	...
	<div class="basediv-transfer">
		...
		<div class="buttons">
			<button-vue
				...
				color="#007d71"
				@clickevent="onMove2Owned"
			></button-vue>
			<button-vue
				class="button-right"
				icon="icon-icon-test1"
				color="#007d71"
				@clickevent="onMove2Available"
			></button-vue>
		</div>
		<div class="right">
...
export default {
	...
	watch: {
		availableOptions: function(val) {
			this.availableOps = [...val];
		},
		ownedOptions: function(val) {
			this.ownedOps = [...val];
		}
	},
	methods: {
		...
		reportResult: function() {
			this.$emit("resultevent", this.ownedOps);
		}
	}
};
</script>
